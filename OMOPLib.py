...
def LoadOMOPtoNeo4j():
    ...
    Neo4jLib.CypherBoltQuery("match (n) delete n","",db="")
    ...
    Neo4jLib.CreateIndex("Person","person_id",db="")
    Neo4jLib.CreateIndex("Provider","provider_id",db="")
    Neo4jLib.CreateIndex("CareSite","care_site_id",db="")
    ...
    Neo4jLib.CreateIndex("Visit_Occurrence","visit_occurrence_id",db="")
    Neo4jLib.CreateIndex("Visit_Occurrence","person_id_id",db="")
    Neo4jLib.CreateIndex("Visit_Occurrence","provider_id",db="")
    Neo4jLib.CreateIndex("Visit_Occurrence","care_site_id",db="")
    ...
    Neo4jLib.CreateIndex("Condition","condition_concept_id",db="")
   ...
   ###  Ontologies
    ...
    Neo4jLib.CreateIndex("Concept","concept_id",db="")
    Neo4jLib.CreateIndex("Concept","concept_name",db="")
    ...
    Neo4jLib.UploadWithPeriodicCommit(CQ,db="")
